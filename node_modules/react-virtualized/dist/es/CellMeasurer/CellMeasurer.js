...
var CellMeasurer = function (_Component) {
  babelHelpers.inherits(CellMeasurer, _Component);

  function CellMeasurer(props, state) {
    babelHelpers.classCallCheck(this, CellMeasurer);

    var _this = babelHelpers.possibleConstructorReturn(this, (CellMeasurer.__proto__ || Object.getPrototypeOf(CellMeasurer)).call(this, props, state));
  ...
  babelHelpers.createClass(CellMeasurer, [{
    key: 'getColumnWidth',
